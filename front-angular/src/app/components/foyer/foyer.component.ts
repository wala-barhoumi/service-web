...
export class FoyerComponent implements OnInit {
  ...
  affectAction(){
    console.log(this.universiteSelected);
    console.log(this.idFoyerToAffect)
    this.universityService.affect(this.idFoyerToAffect , this.universiteSelected).subscribe(res=>{
      this.get()
  ...
  //UTIL FONCTION
  onUniversityChange(data: any) {
    this.universiteSelected = data.target.value
  }
  ...
  delete(i: any) {
    this.idFoyerToDelete = i.idUniversite
